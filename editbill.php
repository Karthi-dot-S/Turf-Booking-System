    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input required type="text" class="form-control" name="id" placeholder="turf id" value="<?php echo $std['id']?>">
        </div>

        <div class="form-group">
          <label for="Address">Extra :</label>
          <input type="text" class="form-control" name="extra" placeholder="extra" value="<?php echo $std['extra_charge']?>">
        </div>
